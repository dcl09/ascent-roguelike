...
class BaseplateBuilderTest {
    ...
    void createLevel_ShouldSetCorrectDimensions() {
        BaseplateBuilder builder = new BaseplateBuilder(30, 20, 4, 1);
    ...
    void createLevel_ShouldCreateBorderWalls() {
        BaseplateBuilder builder = new BaseplateBuilder(10, 8, 0, 0);
    ...
    void createLevel_ShouldCreateRequestedNumberOfMonsters() {
        BaseplateBuilder builder = new BaseplateBuilder(20, 20, 4, 1);
    ...
    void createLevel_ShouldHandlePoolExhaustion() {
        ...
        BaseplateBuilder builder = new BaseplateBuilder(20, 20, 10, 0);
        Floor level = builder.createFloor(new Player(new Position(10, 10)));
